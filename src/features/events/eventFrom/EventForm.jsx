...
export default function EventFrom({ match, history, location }) {
  ...
  async function handleCnacelToggle(event) {
    setConfirmOpen(false);
    setLoadingCancel(true);
    try {
      await cancelEventsToggle(event);
  ...
  return (
    <Segment clearing>
      ...
      >
        {({ isSubmitting, dirty, isValid, values }) => (
          <Form className='ui form'>
            ...
            <Header sub color='teal' content='Event Content Details' />
      ...
      <Confirm
        ...
        onConfirm={() => handleCnacelToggle(selectedEvent)}
      />
    </Segment>
  );
}
